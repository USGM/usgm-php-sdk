...
class ScanPageDto extends JsonSerializableType
{
    /**
     * @var array<ScanPageDtoDataItem> $data
     */
    #[JsonProperty('data'), ArrayType([ScanPageDtoDataItem::class])]
    public array $data;
    ...
    /**
     * @param array{
     *   data: array<ScanPageDtoDataItem>,
     *   totalCount: int,
     *   nextCursor?: ?string,
     * } $values
     */
