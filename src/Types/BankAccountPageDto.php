...
class BankAccountPageDto extends JsonSerializableType
{
    /**
     * @var array<BankAccountPageDtoDataItem> $data
     */
    #[JsonProperty('data'), ArrayType([BankAccountPageDtoDataItem::class])]
    public array $data;
    ...
    /**
     * @param array{
     *   data: array<BankAccountPageDtoDataItem>,
     *   totalCount: int,
     *   nextCursor?: ?string,
     * } $values
     */
