...
class ShipmentPageDto extends JsonSerializableType
{
    /**
     * @var array<ShipmentPageDtoDataItem> $data
     */
    #[JsonProperty('data'), ArrayType([ShipmentPageDtoDataItem::class])]
    public array $data;
    ...
    /**
     * @param array{
     *   data: array<ShipmentPageDtoDataItem>,
     *   totalCount: int,
     *   nextCursor?: ?string,
     * } $values
     */
