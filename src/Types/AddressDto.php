...
class AddressDto extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<AddressDtoType> $type `shipping` = a shipment destination; `deposit` = where check deposits are sent.
     */
    #[JsonProperty('type')]
    public string $type;
