...
class AddressPageDto extends JsonSerializableType
{
    /**
     * @var array<AddressPageDtoDataItem> $data
     */
    #[JsonProperty('data'), ArrayType([AddressPageDtoDataItem::class])]
    public array $data;
    ...
    /**
     * @param array{
     *   data: array<AddressPageDtoDataItem>,
     *   totalCount: int,
     *   nextCursor?: ?string,
     * } $values
     */
